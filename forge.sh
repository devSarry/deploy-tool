...
echo "limitless-pebble" > /etc/hostname
sed -i 's/127\.0\.0\.1.*localhost/127.0.0.1	limitless-pebble localhost/' /etc/hosts
hostname limitless-pebble
...
PASSWORD=$(mkpasswd 2vziKUssneB2RtjsO0Aj)
...
# Laravel Forge
ssh-rsa  worker@forge.laravel.com
...
git config --global user.name "Jonathan Sarry"
git config --global user.email "jonathan.sarry@edu.turkuamk.fi"
...
debconf-set-selections <<< "mariadb-server-10.0 mysql-server/root_password password iqQMOm4Yg8ybKf5McZt1"
debconf-set-selections <<< "mariadb-server-10.0 mysql-server/root_password_again password iqQMOm4Yg8ybKf5McZt1"
...
mysql --user="root" --password="iqQMOm4Yg8ybKf5McZt1" -e "GRANT ALL ON *.* TO root@'188.166.18.140' IDENTIFIED BY 'iqQMOm4Yg8ybKf5McZt1';"
mysql --user="root" --password="iqQMOm4Yg8ybKf5McZt1" -e "GRANT ALL ON *.* TO root@'%' IDENTIFIED BY 'iqQMOm4Yg8ybKf5McZt1';"
service mysql restart

mysql --user="root" --password="iqQMOm4Yg8ybKf5McZt1" -e "CREATE USER 'forge'@'188.166.18.140' IDENTIFIED BY 'iqQMOm4Yg8ybKf5McZt1';"
mysql --user="root" --password="iqQMOm4Yg8ybKf5McZt1" -e "GRANT ALL ON *.* TO 'forge'@'188.166.18.140' IDENTIFIED BY 'iqQMOm4Yg8ybKf5McZt1' WITH GRANT OPTION;"
mysql --user="root" --password="iqQMOm4Yg8ybKf5McZt1" -e "GRANT ALL ON *.* TO 'forge'@'%' IDENTIFIED BY 'iqQMOm4Yg8ybKf5McZt1' WITH GRANT OPTION;"
mysql --user="root" --password="iqQMOm4Yg8ybKf5McZt1" -e "FLUSH PRIVILEGES;"
...
mysql --user="root" --password="iqQMOm4Yg8ybKf5McZt1" -e "CREATE DATABASE makkraperuna;"
...
sudo -u postgres psql -c "CREATE ROLE forge LOGIN UNENCRYPTED PASSWORD 'iqQMOm4Yg8ybKf5McZt1' SUPERUSER INHERIT NOCREATEDB NOCREATEROLE NOREPLICATION;"
...
sudo -u postgres /usr/bin/createdb --echo --owner=forge makkraperuna
...
curl --insecure --data "event_id=8841402&server_id=121790&sudo_password=2vziKUssneB2RtjsO0Aj&db_password=iqQMOm4Yg8ybKf5McZt1" https://forge.laravel.com/provisioning/callback/app
